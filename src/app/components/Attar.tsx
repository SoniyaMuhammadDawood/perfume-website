  ...
  return (
    <div className="bg-blue-50">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mx-6 lg:mx-12">
        {/* Card Component */}
        {[
          { src: '/images/attar14.png', title: 'Oud Moutar' },
          { src: '/images/attar13.png', title: 'Taaj' },
          { src: '/images/attar11.png', title: 'Sandalwood Attar' },
          { src: '/images/attar4.png', title: 'Attar Story ' },
          { src: '/images/attar1.png', title: 'Adeen' },
          { src: '/images/attar16.png', title: 'Musk Al Tahara' },
          { src: '/images/attar8.png', title: 'Al-Arabi' },
          { src: '/images/attar9.png', title: 'Rose Malaki' },
        ].map((item, index) => (
