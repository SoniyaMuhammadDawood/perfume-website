...
const page = () => {
  ...
  <div className="min-h-[96vh]  bg-gray-100 text-gray-900 flex justify-center">
    <div className="max-w-screen-lg m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
      <div className="lg:w-1/2 xl:w-6/12 p-8 sm:p-12">
          ...
          <div className="w-full flex-1 mt-6">
            ...
            <div className="mx-auto max-w-xs">
              ...
              <p className="mt-6 text-xs text-gray-600 text-center">
                ...
                and its
                <a href="#" className="border-b border-gray-500 border-dotted mb-6">
                  Privacy Policy
                </a>
              </p>
            </div>
